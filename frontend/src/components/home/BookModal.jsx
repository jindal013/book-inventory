...
const BookModal = ({ book, onClose }) => {
  return (
    <div
      className="fixed bg-black/60 top-0 bottom-0 left-0 right-0 flex justify-center items-center z-50"
      onClick={onClose}
    >
      <div
      ...
      >
        ...
        <p className="my-2">
          ...
          accusantium dicta assumenda repellendus neque odio quae sequi facere
          odit et.
        </p>
      </div>
    </div>
